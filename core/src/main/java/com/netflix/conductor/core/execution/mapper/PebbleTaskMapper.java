 ...
 */
@Component
public class PebbleTaskMapper implements TaskMapper {

    public static final Logger LOGGER = LoggerFactory.getLogger(PebbleTaskMapper.class);
    private final ParametersUtils parametersUtils;
    private final MetadataDAO metadataDAO;

    public PebbleTaskMapper(ParametersUtils parametersUtils, MetadataDAO metadataDAO) {
    ...
    public List<TaskModel> getMappedTasks(TaskMapperContext taskMapperContext) {
        ...
        LOGGER.debug("TaskMapperContext {} in PebbleTaskMapper", taskMapperContext);
        ...
        taskModel.setTaskType(TaskType.TASK_TYPE_PEBBLE);
